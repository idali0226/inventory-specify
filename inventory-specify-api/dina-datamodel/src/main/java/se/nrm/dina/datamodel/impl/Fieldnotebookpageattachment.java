...
public class Fieldnotebookpageattachment extends BaseEntity {
    ...
    public Fieldnotebookpageattachment(Integer fieldNotebookPageAttachmentId, Date timestampCreated, int ordinal) {
        this.fieldNotebookPageAttachmentId = fieldNotebookPageAttachmentId;
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        return !((this.fieldNotebookPageAttachmentId == null && other.fieldNotebookPageAttachmentId != null) || (this.fieldNotebookPageAttachmentId != null && !this.fieldNotebookPageAttachmentId.equals(other.fieldNotebookPageAttachmentId)));
    }

    @Override
    public String toString() {
        return "se.nrm.dina.datamodel.Fieldnotebookpageattachment[ fieldNotebookPageAttachmentId=" + fieldNotebookPageAttachmentId + " ]";
    }  
}
