...
public class Exchangeoutprep extends BaseEntity {
    ...
    public String getIdentityString() {
        return String.valueOf(exchangeOutPrepID);
    }
    
//    @XmlAttribute(name = "uuid") 
//    @Override
//    public String getUUID() {
//        return Util.getInstance().getURLLink(this.getClass().getSimpleName()) + exchangeOutPrepID;
//    }
    ...
    public boolean equals(Object object) {
        ...
        return !((this.exchangeOutPrepID == null && other.exchangeOutPrepID != null) || (this.exchangeOutPrepID != null && !this.exchangeOutPrepID.equals(other.exchangeOutPrepID)));
    }
