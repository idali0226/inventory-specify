...
public class Conserveventattachment extends BaseEntity {
    ...
    public Conserveventattachment(Integer conservEventAttachmentID, Date timestampCreated, int ordinal) {
        this.conservEventAttachmentID = conservEventAttachmentID;
    ...
    public String getIdentityString() {
        return String.valueOf(conservEventAttachmentID);
    }
    
//    @XmlAttribute(name = "uuid") 
//    @Override
//    public String getUUID() {
//        return Util.getInstance().getURLLink(this.getClass().getSimpleName()) + conservEventAttachmentID;
//    }
    ...
    public boolean equals(Object object) {
        ...
        return !((this.conservEventAttachmentID == null && other.conservEventAttachmentID != null) || (this.conservEventAttachmentID != null && !this.conservEventAttachmentID.equals(other.conservEventAttachmentID)));
    }

    @Override
    public String toString() {
        return "se.nrm.dina.datamodel.Conserveventattachment[ conservEventAttachmentID=" + conservEventAttachmentID + " ]";
    } 
}
